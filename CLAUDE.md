...
`AccionesRolSchema` (`src/interfaces/rol.ts`) es la fuente de verdad. Módulos: `Administración`, `Hardware`, `Visitas`, `Vehículos`, `Mascotas`, `Movimientos`, `Publicaciones`, `Tickets`, `Turnos`, `Encuestas`, `Expensas`, `Infracciones`, `Egresos`.
